...
<script>alert(0)</script> is enough


when security of website is medium

it filter some charset for example 

it use function to filter
    $name = str_replace( '<script>', '', $_GET[ 'name' ] ); 
	
	when charset have script it will replace to '' 
	
	
in this case : we should inject via body
